...
//  HateDatingApp
//
//  Created by Prithviraj Murthy on 04/04/19.
...
struct Colors {
    ...
    static let lightBlue        = UIColor(red: 0/255, green: 151/255, blue: 211/255, alpha: 1.0)
    static let darkBlue         = UIColor(red: 0/255, green: 89/255, blue: 255/255, alpha: 1.0)
    static let skyBlue          = UIColor(red: 0, green: 0.7412, blue: 0.9686, alpha: 1.0)
    static let lightPink        = UIColor(red: 238/255, green: 44/255, blue: 244/255, alpha: 1.0)
}
